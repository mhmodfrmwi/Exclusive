                ...
                <CardContent className="flex flex-col aspect-square items-center justify-center p-6">
                  <span className="text-2xl font-semibold">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(#clip0_7739_1959)">
                        <path
